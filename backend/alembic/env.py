...
# backend/ kökünü sys.path'e ekle, "app" paketi import edilebilsin
...
# alembic.ini'deki sabit URL yerine ortam değişkenini kullan
...
# autogenerate desteği için proje modellerinin metadata'sı
